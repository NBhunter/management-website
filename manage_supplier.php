...
<div class="container-fluid">
	<div class="col-lg-12">
		<form action="" id="manage-supplier">
			...
			<div class="form-group">mã nhà cung cấp</label>
					<textarea name="mancc" cols="30" rows="2" class="form-control"><?php echo isset($mancc) ? $mancc: '' ?></textarea>
					</div>
				<div class="form-group">
					<label for="" class="control-label">Tên nhà cung cấp</label>
					<textarea name="sup_name" cols="30" rows="2" class="form-control"><?php echo isset($sup_name) ?$sup_name: '' ?></textarea>
					</div>
				<div class="form-group">
					<label for="" class="control-label">địa chỉ</label>
					<textarea name="sup_address" cols="30" rows="2" class="form-control"><?php echo isset($sup_address) ? $sup_address : '' ?></textarea>
				</div>
