...
<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Thêm phiếu chi khách hàng</h5>
								</div>
								<div class="card-body">
									<form id="manage-leave-customer">
										<div class="row">
...
<!-- <div class="container-fluid">
	<div class="col-lg-12">
	<div class="card-header">
									<h1 class="card-title"> Phiếu chi khách hàng</h1>
									
								</div>
		<form action="" id="manage-leave-customer" >
			<input type="hidden" name="id" value="<?php $t=time();
 echo isset($id) ? $id : '' ?>">
			<input type="hidden" name="type" value="<?php echo isset($type) ? $type : '2' ?>">
			<div class="form-group">
...
<script>
	...
	$('#manage-leave-customer').submit(function(e){
	// 	$customer_id='';
	...
	// alert($customer_id);
		...
		start_load()
		$.ajax({
			url:'ajax.php?action=save_leave_customer',
			method:'POST',
			data:$(this).serialize(),
			success:function(resp){
				if(resp == 1){
