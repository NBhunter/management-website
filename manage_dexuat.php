...
<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Thêm phiếu đề xuất</h5>
								</div>
								<div class="card-body">
									<form action="upload.php" method="post" enctype="multipart/form-data">
									<input type="hidden" name="id" value="<?php $t=time(); echo isset($id) ? $id : '' ?>">
            ...
            <!-- <input type="submit" class="button" value="Send" id="but_upload"> -->
...
// //  var bophan = document.getElementById("bophan").vaule;
...
// 	fd.append('file',files[0]);
// 	// fd.append('id',id);
// 	// fd.append('bophan', bophan);
// 	// fd.append('noidung',noidung);
// 	// fd.append('kinhphi',kinhphi);
// 	// fd.append('thoigianbatdau',thoigianbatdau);
// 	// fd.append('thoigianketthuc',thoigianketthuc);
// 	// fd.append('Ngaytaophieu',Ngaytaophieu);
