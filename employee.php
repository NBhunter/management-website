							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-primary view_employee" type="button" data-id="<?php echo $row['id'] ?>" >Xem</button>
										<button class="btn btn-sm btn-outline-primary edit_employee" type="button" data-id="<?php echo $row['id'] ?>" >Sửa</button>
										<button class="btn btn-sm btn-outline-danger delete_employee" type="button" data-id="<?php echo $row['id'] ?>">Xóa</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('#new_employee').click(function(){
		location.replace("index.php?page=manage_employee")
	})
	
	$('.edit_employee').click(function(){
		var link = "./index.php?page=manage_employee&id="+$(this).attr('data-id');
		location.replace(link)
		
	})
	$('.view_employee').click(function(){
		var link = "./index.php?page=view_employee&id="+$(this).attr('data-id');
		location.replace(link)
	})
	$('.delete_employee').click(function(){
		delete_employee($(this).attr('data-id'))
	})
